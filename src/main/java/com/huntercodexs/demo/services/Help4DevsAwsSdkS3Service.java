...
public class Help4DevsAwsSdkS3Service {
    ...
    public Help4DevsAwsSdkS3ResponseDto uploadFile(MultipartFile multipartFile) {
        ...
        Help4DevsAwsSdkS3ResponseDto help4DevsAwsSdkS3ResponseDto = new Help4DevsAwsSdkS3ResponseDto();
        help4DevsAwsSdkS3ResponseDto.setFilename(fileName);
        help4DevsAwsSdkS3ResponseDto.setMessage("Upload successfully");

        if (file.exists() && file.delete()) {
            log.error("File not deleted: {}", file.getAbsolutePath());
        }

        return help4DevsAwsSdkS3ResponseDto;
    }
    ...
    public Help4DevsAwsSdkS3ResponseDto deleteFile(String fileName) {
        s3Client.deleteObject(s3BucketName, fileName);
        Help4DevsAwsSdkS3ResponseDto help4DevsAwsSdkS3ResponseDto = new Help4DevsAwsSdkS3ResponseDto();
        help4DevsAwsSdkS3ResponseDto.setFilename(fileName);
        help4DevsAwsSdkS3ResponseDto.setMessage("File removed successfully");
        return help4DevsAwsSdkS3ResponseDto;
    }
